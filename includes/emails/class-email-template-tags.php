			...
			foreach ( $order_trips as $trip ) :
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="alignright"><?php echo $trip->has_time ? wp_date( 'Y-m-d H:i', strtotime( $trip->end_datetime ) ) : wp_date( get_option( 'date-format', 'Y-m-d' ), strtotime( $trip->end_datetime ) ); ?></td>
					</tr>
					<?php endif; ?>
					<tr>
