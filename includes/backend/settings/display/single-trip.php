			...
			<div class="wte-pricing-layout">
				...
				<label class="wpte-field-label" for="<?php echo esc_attr( $layout ); ?>">
					<figure>
						...
						<img src="<?php echo WP_TRAVEL_ENGINE_FILE_URL . '/public/images/' . $layout . '.gif'; ?>" alt="pricing-layout">
					</figure>
				</label>
			</div>
		<?php } ?>
...
if ( $show_itinerary_toggle ) :
	...
	?>
<div class="wpte-field wpte-checkbox advance-checkbox">
	<label class="wpte-field-label" data-wte-update="wte_new_5.6.0" for="wp_travel_engine_settings[wte_advance_itinerary][enable_expand_all]"><?php _e( 'Always Show  All Itinerary', 'wp-travel-engine' ); ?></label>
	<div class="wpte-checkbox-wrap">
	...
	<span class="wpte-tooltip"><?php _e( 'Default: All shown. Enable this option to always expand all itinerary on initial page load.', 'wp-travel-engine' ); ?></span>
</div>
<?php endif; ?>
