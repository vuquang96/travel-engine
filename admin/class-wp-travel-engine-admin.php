		...
		if ( isset( $response_data ) && count( $response_data ) > 0 ) {
				...
				<div class="wpte-dashboard-widget_table-wrap">
					<table>
						...
						<tr>
							...
							<td><strong><?php echo esc_attr( $current_month[0]->total_bookings ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Booking Value', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $current_month[0]->total_amount ) ) ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Payment Received', 'wp-travel-engine' ); ?></td>
							<td><strong> <?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $current_month[0]->total_earnings ) ) ); ?> </strong></td>
						</tr>
					</table>
				</div>
				<div class="wpte-dashboard-widget_table-wrap">
					<table>
						...
						<tr>
							<td><?php esc_html_e( 'No. of Bookings', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( $today[0]->total_bookings ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Booking Value', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $today[0]->total_amount ) ) ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Payment Received', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $today[0]->total_earnings ) ) ); ?></strong></td>
						</tr>
					</table>
				</div>
				<div class="wpte-dashboard-widget_table-wrap">
					<table>
						...
						<tr>
							<td><?php esc_html_e( 'No. of Bookings', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( $last_month[0]->total_bookings ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Booking Value', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $last_month[0]->total_amount ) ) ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Payment Received', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $last_month[0]->total_earnings ) ) ); ?></strong></td>
						</tr>
					</table>
				</div>
				<div class="wpte-dashboard-widget_table-wrap">
					<table>
						...
						<tr>
							<td><?php esc_html_e( 'No. of Bookings', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( $overall_data[0]->total_bookings ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Booking Value', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $overall_data[0]->total_amount ) ) ); ?></strong></td>
						</tr>
						<tr>
							<td><?php esc_html_e( 'Payment Received', 'wp-travel-engine' ); ?></td>
							<td><strong><?php echo esc_attr( preg_replace( '/\s+/', '', wte_get_formated_price( $overall_data[0]->total_earnings ) ) ); ?></strong></td>
						</tr>
					</table>
				</div>
			</div>
			...
			<div class="wpte-dashboard-widget_customers-status">
				<div class="wpte-dashboard-widget_status-item">
					...
					<strong class="value"> <?php echo esc_attr( $customer_range['mtd'][0] ); ?> <span class="status-<?php echo esc_attr( $customer_range['mtd'][2] ); ?>">(<?php echo esc_attr( $customer_range['mtd'][1] ); ?>)</span> </strong>
				</div>
				<div class="wpte-dashboard-widget_status-item">
					<span class="label"><?php esc_html_e( 'This Year', 'wp-travel-engine' ); ?></span>
					<strong class="value"> <?php echo esc_attr( $customer_range['yoy'][0] ); ?> <span class="status-<?php echo esc_attr( $customer_range['yoy'][2] ); ?>">(<?php echo esc_attr( $customer_range['yoy'][1] ); ?>)</span> </strong>
				</div>
				<div class="wpte-dashboard-widget_status-item">
					<span class="label"><?php esc_html_e( 'This Month (yoy)', 'wp-travel-engine' ); ?></span>
					<strong class="value"> <?php echo esc_attr( $customer_range['yom'][0] ); ?> <span class="status-<?php echo esc_attr( $customer_range['yom'][2] ); ?>">(<?php echo esc_attr( $customer_range['yom'][1] ); ?>)</span> </strong>
				</div>
			</div>
			...
			<ul>
				...
				<li>
					...
					<span class="date"><?php echo esc_attr( $customers['date'] ); ?></span>
				</li>
				<?php } ?>
			</ul>
